...
function Changelog() {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/repos/onezer00/mu-login-manager-releases/releases?per_page=8', { signal: controller.signal, headers: { Accept: 'application/vnd.github+json' } })
